...
export const UploadExcelFile = async (file) => {
  ...
  export const GetAllExcelFiles = async () => {
    try {
        const response = await axios.get('/get-excel-all');
        console.log("Response from GetAllExcelFiles: ", response.data); // Log the response
        return response.data; // Assuming response.data should be an array
    } catch (error) {
